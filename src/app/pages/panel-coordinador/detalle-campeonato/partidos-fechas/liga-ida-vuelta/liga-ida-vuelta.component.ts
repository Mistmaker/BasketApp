...
@Component({
  selector: 'app-liga-ida-vuelta',
  templateUrl: './liga-ida-vuelta.component.html',
  styleUrls: ['./liga-ida-vuelta.component.scss']
})
export class LigaIdaVueltaComponent implements OnInit {
  ...
  generarTodoAutomatico(): void {
    ...
    for (let i = 0; i < cantidadEquipos; i++) {
      ...
      this.guardarFechaElimDobleAutomatico('', '', ultimo);
    }
  }

  guardarFechaElimDobleAutomatico(f1: string, f2: string, ultimo: boolean): void {
